...
//SYSPRINT DD SYSOUT=*
//SYSIN DD *
  DELETE Z95629.QSAM.AA NONVSAM
  IF LASTCC LE 08 THEN SET MAXCC = 00
//SORT0200 EXEC PGM=SORT
//SYSOUT  DD SYSOUT=*
//SORTIN  DD *
0003MUSTAFA        GERMIYAN       20230630
0002HALIM          GERMIYAN       19150617
0001RUSEN          GERMIYAN       19231029
//SORTOUT DD DSN=Z95629.QSAM.AA,
...
//FILE01  DD DSN=Z95629.QSAM.BB,
//            DISP=(MOD,DELETE,DELETE),SPACE=(TRK,0)
//SORT0400 EXEC PGM=SORT
//SYSOUT  DD SYSOUT=*
//SORTIN  DD DSN=Z95629.QSAM.AA,DISP=SHR
//SORTOUT DD DSN=Z95629.QSAM.BB,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(5,5),RLSE),
